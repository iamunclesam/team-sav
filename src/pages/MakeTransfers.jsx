            ...
            <div className="rounded-xl shadow-sm mb-6">
                <div className="grid grid-cols-2 gap-4">
                    <button
                        ...
                        className={`rounded-xl flex items-center text-base justify-center gap-4 transition-all ${transferType === 'internal'
                            ? 'bg-blue-50 border-2'
                    ...
                    >
                        ...
                        />
                        <span className={transferType === 'internal' ? '' : 'text-gray-500'}>
                            Between Splits
                        </span>
                    </button>
                    <button
                        onClick={() => setTransferType('external')}
                        className={`p-4 rounded-xl flex items-center justify-center gap-2 transition-all ${transferType === 'external'
                            ? 'bg-blue-50 border-2 '
                            : 'border-2 border-gray-100'
                            }`}
                    >
                        ...
                        />
                        <span className={transferType === 'external' ? '' : 'text-gray-500'}>
                            External Account
                        </span>
                    </button>
                </div>
